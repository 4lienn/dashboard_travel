...
<body>
    <div class="container">
        ...
        <form action="#" method="POST">
            ...
            <input type="text" id="asal" name="asal" placeholder="Masukkan kota asal" required>

            <label for="tujuan">Tujuan:</label>
            <input type="text" id="tujuan" name="tujuan" placeholder="Masukkan kota tujuan" required>

            <label for="jumlah_penumpang">Jumlah Penumpang:</label>
            <select id="jumlah_penumpang" name="jumlah_penumpang" required>
